...
/// <remarks>
/// <list type="bullet">
/// <item><term>Bills and Coins</term><description><seealso href="https://www.ecb.europa.eu/euro/banknotes/html/index.en.html">Banknotes (European Central Bank)</seealso></description></item>
/// </list>
/// </remarks>
    ...
    ICurrencyFormattable<EurCurrency>
{
    ...
    [
        ...
        new(0.02m, CashType.Coin, "2 Cent Coin", "2 Cent", Usage: CashUsagePolicy.NonRecyclable),
    ...
    [
        ...
        new(500.00m, CashType.Bill, "500 Euro Bill", "500 Euro", Usage: CashUsagePolicy.CollectionOnly),
    ];
