...
/// <summary>Bermudian Dollar Currency</summary>
/// <remarks>
/// <list type="bullet">
/// <item><term>Bills</term><description><seealso href="https://www.bma.bm/polymernotes">BMA (Bermuda Monetary Authority)</seealso></description></item>
/// <item><term>Coins</term><description><seealso href="https://www.bma.bm/introduction">BMA</seealso></description></item>
/// </list>
/// <para>※ New banknotes featuring King Charles III are being introduced from 2024.</para>
/// </remarks>
public class BmdCurrency :
    ICurrency,
    ICashCountFormattable<BmdCurrency>,
    ICurrencyFormattable<BmdCurrency>
{
    /// <inheritdoc/>
    public static Iso4217 Code => Iso4217.BMD;
    /// <inheritdoc/>
