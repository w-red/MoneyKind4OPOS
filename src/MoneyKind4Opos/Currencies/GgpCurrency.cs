...
/// <summary>Guernsey Pound Currency</summary>
/// <remarks>
/// <list type="bullet">
/// <item><term>Bills and Coins</term><description>States of Guernsey</description></item>
/// </list>
/// <para>※ Non-ISO currency code (informal: GGP). Pegged 1:1 to GBP. GBP is also legal tender.</para>
/// <para>※ Guernsey issues £1 notes (unique among pound currencies).</para>
/// </remarks>
public class GgpCurrency :
    ICurrency,
    ICashCountFormattable<GgpCurrency>,
    ICurrencyFormattable<GgpCurrency>
{
    /// <inheritdoc/>
    public static Iso4217 Code => Iso4217.GGP;
    /// <inheritdoc/>
