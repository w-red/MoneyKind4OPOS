...
/// <summary>Burundi Franc (BIF).</summary>
public sealed class BifCurrency : ICurrency, ICashCountFormattable<BifCurrency>, ICurrencyFormattable<BifCurrency>
{
    private BifCurrency() { }

    /// <inheritdoc/>
    public static Iso4217 Code => Iso4217.BIF;
    ...
    public static CurrencyFormattingOptions Global { get; } =
        CurrencyFormattingOptions.Create("FBu", "n $", decimalDigits: 0, groupSep: "\u202F");
