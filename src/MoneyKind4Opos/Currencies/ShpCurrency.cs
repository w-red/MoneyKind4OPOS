...
/// <summary>Saint Helena Pound Currency</summary>
/// <remarks>
/// <list type="bullet">
/// <item><term>Bills and Coins</term><description>Saint Helena Government</description></item>
/// </list>
/// <para>※ Pegged 1:1 to GBP. Also used in Ascension Island and Tristan da Cunha.</para>
/// </remarks>
public class ShpCurrency :
    ICurrency,
    ICashCountFormattable<ShpCurrency>,
    ICurrencyFormattable<ShpCurrency>
{
    /// <inheritdoc/>
    public static Iso4217 Code => Iso4217.SHP;
    /// <inheritdoc/>
