...
/// <summary>Falkland Islands Pound Currency</summary>
/// <remarks>
/// <list type="bullet">
/// <item><term>Bills and Coins</term><description><seealso href="https://falklands.gov.fk/finance/currency">Falkland Islands Government</seealso></description></item>
/// </list>
/// <para>※ Pegged 1:1 to GBP. GBP notes are also legal tender. Transitioning to polymer notes (paper notes expire April 30, 2026).</para>
/// </remarks>
public class FkpCurrency :
    ICurrency,
    ICashCountFormattable<FkpCurrency>,
    ICurrencyFormattable<FkpCurrency>
{
    /// <inheritdoc/>
    public static Iso4217 Code => Iso4217.FKP;
    /// <inheritdoc/>
